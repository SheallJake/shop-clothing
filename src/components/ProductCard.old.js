...
import { BiHeart, BiShoppingBag, BiStar } from "react-icons/bi";
            ...
            <Link href={`/products/${product.id}`}>
              <div className="flex justify-between items-start">
                ...
                <div className="flex items-center gap-1 mb-2">
                  <BiStar className="w-4 h-4 fill-yellow-400 text-yellow-400" />
            ...
            >
              ...
              >
                <span className="relative z-10 flex items-center gap-2">
                  <BiShoppingBag className="w-4 h-4 transition-transform duration-300 group-hover/cart:scale-110" />
